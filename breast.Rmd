...
TCGA에 있는 genes형태의 ID를 firehose의 genes symbol로 mapping할 수 있다.  
TCGA의 count데이터와 firehose의 normalized데이터를 join하여 순수 firehose만의 데이터(mRNA, Clinic)로 분석을 진행할 수 있을 것  
